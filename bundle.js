 ...
 * http://polymer.github.io/PATENTS.txt
 */
const html = (strings, ...values) => new TemplateResult(strings, values, 'html', defaultTemplateProcessor);var render$1 = (container, { field, note }, messages, { state, files }) => {
...
function optional(val) {
...
}class ManilaFodder extends HTMLElement {
	connectedCallback() {
	...
	setState(state) {
		...
		render$1(this, { field, note: this.note }, this.messages,
...
customElements.define("manila-fodder", class extends ManilaFodder {
	...
	setState(state) {
		...
		if(files) {
			render$1(this, { field: this.field, note: this.note }, this.messages,
					{ state, files: files });
		}
	}
});}());